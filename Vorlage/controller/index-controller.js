...
export class IndexController {
  index = async (req, res) => {
    req.session.userSettings.sortBy =
      req.query.sortBy || req.session.userSettings.sortBy;
    req.session.userSettings.sortDirection =
      req.query.sortDirection || req.session.userSettings.sortDirection;
    req.session.userSettings.filterOnCompleted =
      req.query.filterOnCompleted || req.session.userSettings.filterOnCompleted;
    req.session.userSettings.isDarkMode =
      req.query.isDarkMode || req.session.userSettings.isDarkMode;
