...
router.post("/todos", async (req, res) => {
  try {
    ...
    res
      .status(500)
      .send("Oops! An error occurred in the post route in index-routes.js");
  }
});
router.get(
  "/toggle-completed-filter",
  indexController.toggleCompletedFilter.bind(indexController),
);
router.get(
  "/toggle-dark-mode",
  indexController.toggleDarkMode.bind(indexController),
);
